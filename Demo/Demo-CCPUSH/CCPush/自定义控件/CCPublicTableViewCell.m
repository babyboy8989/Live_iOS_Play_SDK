...
-(void)reloadWithDialogue:(Dialogue *)dialogue antesomeone:(AnteSomeone)atsoBlock {
    ...
    NSMutableAttributedString *text = [Utility emotionStrWithString:dialogue.msg y:-8];
...
-(UIButton *)button {
    if(!_button) {
        ...
        [_button setTitleShadowColor:CCRGBAColor(0,0,0,0.50) forState:UIControlStateNormal];
